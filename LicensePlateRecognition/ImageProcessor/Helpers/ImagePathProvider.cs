...
namespace ImageProcessor.Helpers
{
    public interface IImagePathProvider
    {
        ...
        string GetActualLicensePlateFullPath(ImageContext imageContext, int number, string licenseNumber);
    ...
    public class ImagePathProvider : IImagePathProvider
    {
        ...
        public string GetActualLicensePlateFullPath(ImageContext imageContext, int number, string licenseNumber) => @$"{imageContext.FolderPath}\Actual\{imageContext.FileName}\{number}_{licenseNumber}.png";
