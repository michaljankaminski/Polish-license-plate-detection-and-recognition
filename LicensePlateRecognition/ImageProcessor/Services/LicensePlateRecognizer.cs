        ...
        public void RecognizePlate(ImageContext imageContext, bool useTesseract = true)
        {
          // RecognizePlateWithSplit(imageContext);
           RecognizePlate(imageContext);
            //LicensePlateRecognition.LicensePlateDetector test = new LicensePlateRecognition.LicensePlateDetector();

            //var inputOutputArrays = new List<IInputOutputArray>();
            //var filtered = new List<IInputOutputArray>();
            //var rotatedRects = new List<RotatedRect>();

            //var result = test.DetectLicensePlate(imageContext.ProcessedBitmap.ToMat(), inputOutputArrays, filtered, rotatedRects);
            //Console.WriteLine($"{imageContext.FileName} {String.Join(Environment.NewLine, result));
        }
